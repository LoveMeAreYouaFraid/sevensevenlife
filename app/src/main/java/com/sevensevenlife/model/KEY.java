...
public class KEY {
    public static final String CAR_RENTAL = "CarRentals";//租车方式
    public static final String BAND_CAR = "band_car";//绑卡
    public static final String MONEY = "money";//押金
    ...
    public static String ORDER_MODE = "ORDER_MODE";
