...
import com.example.youxiangshenghuo.databinding.MyHomeActivityLayoutBinding;
import com.example.youxiangshenghuo.databinding.MyHomeActivityListItemBinding;
...
public class MyHomeActivity extends BaseActivity implements View.OnClickListener, MyHttpCallBack
        , BindViewInterface {
    private MyHomeActivityLayoutBinding binding;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.my_home_activity_layout);
        ...
        adapter = new PublicAdapter<>(list, R.layout.my_home_activity_list_item, this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_back:
                ...
                break;
            case R.id.add_home:
                startActivityForResult(new Intent(mContext, MyHomeHomeActivity.class)
    ...
    public void bandView(ViewDataBinding binding, final int position) {
        MyHomeActivityListItemBinding bin = (MyHomeActivityListItemBinding) binding;
        bin.name.setText(list.get(position).getCommunity_name());
        bin.name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyApplication.getInstance().setCommunityId(list.get(position).getId());
                startActivity(new Intent(mContext, HomeBusinessActivity.class)
                        .putExtra(KEY.NAME, list.get(position).getCommunity_name())
