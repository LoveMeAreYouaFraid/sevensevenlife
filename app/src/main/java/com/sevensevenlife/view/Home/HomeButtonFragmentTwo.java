...
public class HomeButtonFragmentTwo extends Fragment implements View.OnClickListener {
    ...
    private static ListItemListenerTwo listenerTwo;

    public HomeButtonFragmentTwo(List<FirstLevelProjecMode> list) {
        this.list = list;
    }


    public HomeButtonFragmentTwo setListItemListenerTwo(ListItemListenerTwo l) {
        listenerTwo = l;
        return this;
    }
