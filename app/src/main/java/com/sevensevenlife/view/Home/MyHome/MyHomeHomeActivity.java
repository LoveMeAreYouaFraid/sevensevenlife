...
import com.example.youxiangshenghuo.databinding.MyHomeHomeActivityLayoutBinding;
import com.example.youxiangshenghuo.databinding.MyHomeHomeListItemBinding;
...
public class MyHomeHomeActivity extends BaseActivity implements MyHttpCallBack, View.OnClickListener,
        BindViewInterface, DialogListener {
    private MyHomeHomeActivityLayoutBinding binding;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.my_home_home_activity_layout);
        ...
        adapter = new PublicAdapter<>(homeNameList, R.layout.my_home_home_list_item, this);
    ...
    public void bandView(ViewDataBinding binding, final int position) {
        MyHomeHomeListItemBinding bin = (MyHomeHomeListItemBinding) binding;
            ...
            public void onClick(View v) {
                ...
                new TitleDialog()
                        .SHOW(mContext, new String[]{"确定添加" + homeNameList.get(position).getCommunity_name() + "为默认小区?",
                                "确定", "取消"}, MyHomeHomeActivity.this, true);
            }
        });
    }
