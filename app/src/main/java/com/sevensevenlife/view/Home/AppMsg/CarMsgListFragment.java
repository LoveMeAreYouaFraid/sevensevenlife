...
public class CarMsgListFragment extends Fragment implements MyHttpCallBack, BindViewInterface {
    ...
    public void bandView(ViewDataBinding binding, final int position) {
        ...
        final MsgContent msgContent = new JsonUtil<MsgContent>().json2Bean(listBens.get(position).getContent(), MsgContent.class.getName());
                            ...
                            public void buttType(int ButtType) {
                                if (ButtType == 1) {
                                    MyRequest.POST(GET, new String[]{"sessionId", "id"}, new String[]{
                                            ...
                                            .getName(), 12, CarMsgListFragment.this);
                                }
                            }
                        });
            }
    ...
    public void getData() {
        ...
        MyRequest.POST(GET, new String[]{"sessionId", "pageNum", "pageSize", "code"}, new String[]{
                ...
                "10",
                "005"
        }, PUSh_MESSAGE, MessageMode.class.getName(), 11, this);
    }
}
