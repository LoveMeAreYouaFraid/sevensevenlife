...
public class TextViewParser {
    ...
    private static List<TextBean> textList;
    ...
    public TextViewParser setTxt(String text, int size, int color) {

        TextBean bean = new TextBean();
        bean.text = text;
        bean.size = size;
        bean.color = ContextCompat.getColor(MyApplication.getInstance(), color);
        textList.add(bean);
